...
export const timberFire: Incident = {
  ...
  headline:
    "Highway 1 through Big Sur is open again — the closure was lifted on 22 August and the fire is no longer on the coast. The Timber Fire is still burning and still growing, but it has moved inland into the Ventana Wilderness, and the evacuation zones have moved with it.",
  asOf: "Monday, 24 August 2026, 10:27am, read from CAL FIRE's own incident record",
  size: "12,616 acres — up roughly 3,950 acres since Saturday evening",
  containment:
    "25% contained, the same figure as Saturday: the fire has grown by almost half again in two days, so crews holding at 25% are cutting new line about as fast as the fire is making new perimeter",
  started: "Saturday, 8 August, on Los Padres National Forest land; cause under investigation",
  roadClosure:
    "Highway 1 is open. The closure between mile marker 42.6 and mile marker 37 was lifted on Saturday 22 August, and Highway 1 has since dropped off the incident's own closure list entirely — the only road closure the fire still carries is on Los Padres National Forest trails and roads. Caltrans' statewide conditions service lists no Timber Fire restriction anywhere on Highway 1 in Monterey County either. The one Monterey County restriction it does list is unrelated to the fire: one-way control at Rocky Creek Bridge, 15.7 miles south of Monterey, for construction through 31 August.",
  evacuationOrders: [
    "MRY-D082",
    "MRY-D089",
    "MRY-D090",
  ...
  closures: [
    "All four Big Sur state parks are still closed, and this is the closure most likely to affect a day out: Andrew Molera, Julia Pfeiffer Burns, Pfeiffer Big Sur and Point Sur. Each park's own page on parks.ca.gov confirmed it closed on 24 August, with no reopening date given. The road being open does not mean the parks along it are.",
    ...
    "Nepenthe and the Phoenix Shop reopened on Saturday 22 August, and the Henry Miller Memorial Library went back to 11am–5pm the same day. Both are now reachable from either direction.",
  ...
  eventImpact: [
    ...
    "Anything on this site taking place in Big Sur, or reached by driving Highway 1 south of Carmel, should still be confirmed with its organiser before you travel. The road reopened faster than the venues on it did, and all four state parks are still shut.",
    "The fire's growth is now inland and northward — up the Lion Creek drainage toward Ventana Double Cone and the upper Carmel River basin — rather than toward the coast. If it keeps going that way the places affected stop being Big Sur and start being Carmel Valley, so that is the direction to watch for events listed here.",
  ...
  detour:
    "No detour is needed for the fire any more — Highway 1 is through-routed between the Peninsula and San Simeon again. Allow for one-way control at Rocky Creek Bridge, which is roadworks rather than fire, through 31 August.",
  evacuationPoint:
    "The zones under order changed completely on Monday 24 August, and they are not the ones this page listed last week: the coastal Big Sur zones have been released and the orders have moved inland, into the D-series zones and MRY-F031-A. MRY-F028-B went the other way, from warning to order. The evacuation shelter at Carmel Middle School closed on Wednesday 19 August. The county's information line is (831) 647-7760, and Ready Monterey County below carries the live zone map.",
  sources: [
...
export const closures: Closure[] = [
  {
    ...
    when: "Closed Tuesday, August 11 to Saturday, August 22. Reopened at 1pm on the 22nd and open since",
    reason:
      "Closed for public and firefighter safety because of the Timber Fire, after the northern limit moved south twice, to mile marker 42.6. Caltrans reopened it at 1pm on Saturday 22 August and it has stayed open: Highway 1 has since dropped off the incident's own closure list, and Caltrans lists no fire restriction on it in Monterey County. Kept here because the closure is recent enough that older roundups still describe it as current. The state parks along the reopened stretch are a different matter — all four are still shut. See the full detail and live links at the top of this page.",
    confidence: "official",
